...
export default function Services() {
  return (
    <section className="bg-black px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32">
      ...
      <div className="max-w-5xl mx-auto flex flex-col">
        {services.map((svc, i) => (
          ...
          >
            <div className="font-heading italic font-normal text-[clamp(3rem,10vw,140px)] text-white/20 leading-[0.9] shrink-0 w-[120px] sm:w-[180px] md:w-[220px]">
              {svc.num}
            </div>
            <div className="flex flex-col gap-2 sm:gap-4 mt-2 sm:mt-4">
              ...
              <p className="font-light leading-relaxed max-w-2xl text-lg sm:text-xl text-white/60">
                {svc.desc}
              </p>
            </div>
          </FadeIn>
