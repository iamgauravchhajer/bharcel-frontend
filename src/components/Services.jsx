  ...
  return (
    <section className="bg-white rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32">
      <FadeIn delay={0} y={40} className="flex justify-center">
        <h2 className="font-heading italic font-normal text-[#0C0C0C] text-[clamp(3rem,12vw,160px)] mb-16 sm:mb-20 md:mb-28 leading-[0.9]">
          Services
        </h2>
      </FadeIn>
      ...
      <div className="max-w-5xl mx-auto flex flex-col">
        {services.map((svc, i) => (
          <FadeIn 
            ...
            duration={0.7} 
            y={20}
            className="flex flex-col sm:flex-row border-b border-[rgba(12,12,12,0.15)] py-8 sm:py-10 md:py-12 gap-6 sm:gap-10 md:gap-16 items-start"
          >
            <div className="font-heading italic font-normal text-[clamp(3rem,10vw,140px)] text-[#0C0C0C] leading-[0.9] shrink-0 w-[120px] sm:w-[180px] md:w-[220px]">
              {svc.num}
            </div>
            <div className="flex flex-col gap-2 sm:gap-4 mt-2 sm:mt-4">
              <h3 className="font-heading italic font-normal text-[clamp(1.5rem,2.2vw,2.1rem)] text-[#0C0C0C]">
                {svc.name}
              </h3>
              <p className="font-light leading-relaxed max-w-2xl text-lg sm:text-xl text-gray-600">
                {svc.desc}
              </p>
            </div>
          </FadeIn>
